    ...
    public class PersonnelController : Controller
    {
        ...
        public ActionResult Daily()
        {
            if ((Users)Session["User"] == null)
                ViewBag.editinfo = "false";
            else
                ViewBag.editinfo = com.isCheckRole("人事日报管理", "修改日报信息", ((Users)Session["User"]).UserName, ((Users)Session["User"]).UserNum)?"true":"false";
        ...
        public ActionResult Create()
        {
            ...
            if (((Users)Session["User"]).Role == "文员" || com.isCheckRole("人事日报管理", "提交日报信息", ((Users)Session["User"]).UserName, ((Users)Session["User"]).UserNum))
            {
                return View();
            }
            else
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            if (((Users)Session["User"]).Role == "文员" || com.isCheckRole("人事日报管理", "修改日报信息", ((Users)Session["User"]).UserName, ((Users)Session["User"]).UserNum))
            {
