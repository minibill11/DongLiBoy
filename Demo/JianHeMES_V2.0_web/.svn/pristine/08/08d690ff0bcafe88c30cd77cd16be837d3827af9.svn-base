            ...
            <el-form :inline="true" size="small">
                ...
                <el-form-item label="">
                    ...
                    <a
                        ...
                        v-show="$limit('单个模组老化开始')"
                        ><el-button type="primary" size="small" plain
                            >单个模组开始老化</el-button
                        ></a
                    ><a
                        href="Burn_in_Batch_B"
                        style="margin-left: 10px"
                        v-show="$limit('批量模组老化开始')"
                        ><el-button type="primary" size="small" plain
                            >批量模组开始老化</el-button
                        ></a
                    ><a href="AbnormalRecordInput" style="margin-left: 10px"
                        ><el-button type="primary" size="small" plain
                            >模组老化过程异常输入</el-button
                        ></a
                    ><a
                        href="Burn_in_Batch_F"
                        style="margin-left: 10px"
                        v-show="$limit('批量模组老化完成')"
                        ><el-button type="primary" size="small" plain
                            >批量完成老化</el-button
                        ></a
                    ><a href="BurnInShelfQuery" style="margin-left: 10px"
                        ><el-button type="primary" size="small" plain
                            >老化架查询</el-button
                        ></a
                    >
...
export default {
    ...
    methods: {
        ...
        onQuerySubmit() {
            ...
            query_NewIndex("Burn_in_Api", this.Ordernum).then((res) => {
