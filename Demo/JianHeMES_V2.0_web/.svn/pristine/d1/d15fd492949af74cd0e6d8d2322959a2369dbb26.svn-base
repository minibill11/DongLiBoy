      ...
      <div class="table-height">
        <el-table :data="tableData" max-height="600" border v-loading="loading">
          ...
          <el-table-column label="保养日期" min-width="200" align="center">
            ...
            >
              <template slot-scope="scope">
                <div :class="scope.row[`data${j}`] | setIconClass">
                  <template
                    v-if="
...
.week-success {
  border-top: 25px solid @success-color ;
  border-left: 25px solid transparent;
}

.week-error {
  border-top: 25px solid @error-color ;
  border-left: 25px solid transparent;
}
...
.i-week-success {
  ...
  width: 0;
  height: 0;
  border-top: 20px solid @success-color ;
