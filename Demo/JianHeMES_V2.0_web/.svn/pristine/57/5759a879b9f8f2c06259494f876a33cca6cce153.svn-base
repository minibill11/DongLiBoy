...
<template>
  <div>
    ...
    <div class="se_name">
      ...
      <cExcel :excelData="tableData"  :time="select_month" class="btn" v-show="tableData.length>0"></cExcel>
    </div>
    <!-- 表格 -->
...
import cExcel from "./page-components/_export_summarizing";
export default {
  ...
  mounted() {
    ...
    if(this.$refs.sel.select_department=='全部部门'){
        this.onQueryData()
    }   
  },
  beforeCreate() {},
