            ...
            <el-form :inline="true" size="small">
                ...
                <el-form-item label="">
                    ...
                    <a
                        ...
                        ></a
                    >
                    <a href="/Packagings/lookJson" style="margin-left: 10px"
                        ><el-button type="primary" size="small" plain
                            >模组号使用情况</el-button
                        ></a
                    >
                    <a href="DisplayTotalModule" style="margin-left: 10px"
                        ><el-button type="primary" size="small" plain
                            >模组号信息查看</el-button
                        ></a
                    >
...
export default {
    ...
    methods: {
        ...
        onQuerySubmit() {
            ...
            query_NewIndex("Appearances_Api", this.Ordernum).then((res) => {
