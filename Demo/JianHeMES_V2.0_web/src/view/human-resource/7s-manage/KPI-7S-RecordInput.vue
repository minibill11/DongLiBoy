...
import {regionGetDep,regionGetDis,regionGetPosi,getVersionT,getAllRegin,getTableSelect,getPsionDep,gainImage,DeleteImage,CheckRepeat,SaveRecord,DetailUpImage} from "@/api/hr/kpi-7s";
export default {
