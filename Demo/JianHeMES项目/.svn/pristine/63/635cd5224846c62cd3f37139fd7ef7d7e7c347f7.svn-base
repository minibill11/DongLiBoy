...
namespace JianHeMES.Controllers
{
    public class CommonalityController : Controller
    {
        ...
        #region  插入关联表
        public void InsertRelation(string oldBarcode, string newBarcode, string newOrderNum,string procedure)
        {
            int userid = ((Users)Session["User"]).UserNum;
            BarCodeRelation barcoderelation = new BarCodeRelation() { OldBarCodeNum = oldBarcode, NewBarCodesNum = newBarcode, NewOrderNum = newOrderNum, Procedure = procedure, UsserID = userid, CreateDate = DateTime.Now };
            db.SaveChanges();
        }
        #endregion
    }
