...
namespace JianHeMES.Controllers
{
    public class AssemblesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "Create" });
            }
        ...
        public ActionResult AssembleStationB()
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "AssembleStationB" });
            }
        ...
        public ActionResult AssembleStationF(int? id)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "AssembleStationF" + "/" + id.ToString() });
            }
        ...
        public ActionResult AssembleStationF([Bind(Include = "Id,OrderNum,BarCode_Prefix,BoxBarCode,ModelCollections,AssembleBT,AssemblePrincipal,AssembleFT,AssembleTime,AssembleFinish,Remark")] Assemble assemble)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "AssembleStationF" + "/" + assemble.Id.ToString() });
            }
        ...
        public ActionResult WaterproofTestB()
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "WaterproofTestB" });
            }
        ...
        public ActionResult WaterproofTestF(int? id)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "WaterproofTestF" + "/" + id.ToString() });
            }
        ...
        [HttpPost]
        public ActionResult WaterproofTestF([Bind(Include = "Id,BoxBarCode,WaterproofTestBT,WaterproofTestPrincipal,WaterproofTestFT,WaterproofTestTimeSpan,WaterproofAbnormal,WaterproofMaintaince,WaterproofTestFinish,Remark")] Assemble assemble)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "WaterproofTestF" + "/" + assemble.Id.ToString() });
            }
            ...
            if (assemble.WaterproofTestFT == null)
            {
                ...
                var CT = FC - BC;
                assemble.WaterproofTestTimeSpan = CT;
        ...
        public ActionResult AssembleAdapterCardB()
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "AssembleAdapterCardB" });
            }
        ...
        public ActionResult AssembleAdapterCardF(int? id)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "AssembleAdapterCardF" + "/" + id.ToString() });
            }
        ...
        public ActionResult AssembleAdapterCardF([Bind(Include = "Id,OrderNum,BoxBarCode,ModelCollections,AssembleBT,ModelList,AssemblePrincipal,AssembleFT,AssembleTime,AssembleFinish,WaterproofTestBT,WaterproofTestPrincipal,WaterproofTestFT,WaterproofTestTimeSpan,WaterproofAbnormal,WaterproofMaintaince,WaterproofTestFinish,AssembleAdapterCardBT,AdapterCard_Power_Collection,AdapterCard_Power_List,AssembleAdapterCardPrincipal,AssembleAdapterCardFT,AssembleAdapterTime,AssembleAdapterFinish,ViewCheckBT,AssembleViewCheckPrincipal,ViewCheckFT,ViewCheckTime,ViewCheckAbnormal,ViewCheckFinish,ElectricityCheckBT,AssembleElectricityCheckPrincipal,ElectricityCheckFT,ElectricityCheckTime,ElectricityCheckAbnormal,ElectricityCheckFinish,PQCCheckBT,AssemblePQCPrincipal,AssembleLineId,PQCCheckFT,PQCCheckTime,PQCCheckAbnormal,PQCCheckFinish,Remark")] Assemble assemble)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "AssembleAdapterCardF" + "/" + assemble.Id.ToString() });
            }
        ...
        public ActionResult ViewCheckB()
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "ViewCheckB" });
            }
        ...
        public ActionResult ViewCheckF(int? id)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "ViewCheckF" + "/" + id.ToString() });
            }
        ...
        public ActionResult ViewCheckF([Bind(Include = "Id,BoxBarCode,ViewCheckBT,AssembleViewCheckPrincipal,ViewCheckFT,ViewCheckTime,ViewCheckAbnormal,ViewCheckFinish,Remark")] Assemble assemble)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "ViewCheckF" + "/" + assemble.Id.ToString() });
            }
            assemble = db.Assemble.FirstOrDefault(u => u.Id == assemble.Id);
        ...
        public ActionResult ElectricityCheckB()
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "ElectricityCheckB" });
            }
        ...
        public ActionResult ElectricityCheckF(int? id)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "ElectricityCheckF" + "/" + id.ToString() });
            }
        ...
        public ActionResult ElectricityCheckF([Bind(Include = "Id,BoxBarCode,ElectricityCheckBT,AssembleElectricityCheckPrincipal,ElectricityCheckFT,ElectricityCheckTime,ElectricityCheckAbnormal,ElectricityCheckFinish,Remark")] Assemble assemble)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "ElectricityCheckF" + "/" + assemble.Id.ToString() });
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult PQCCheckB([Bind(Include = "Id,OrderNum,BarCode_Prefix,BoxBarCode,PQCCheckBT,AssemblePQCPrincipal,RepetitionPQCCheck,RepetitionPQCCheckCause,Remark")] Assemble assemble,string nuoBarCode=null)
        {
            ViewBag.OrderList = GetOrderList();//向View传递OrderNum订单号列表.
            if (Session["User"] == null)
            {
            ...
            if (db.Assemble.FirstOrDefault(u => u.BoxBarCode == assemble.BoxBarCode) == null)
            {
                if (assemble.OrderNum == db.BarCodes.Where(u => u.BarCodesNum == assemble.BoxBarCode).FirstOrDefault().OrderNum)
                {
                    ...
                    if (!string.IsNullOrEmpty(nuoBarCode) && recount == 0)
                        comm.InsertRelation(nuoBarCode, assemble.BoxBarCode, assemble.OrderNum, "PQC");
        ...
        public ActionResult AssembleIndex2()
        {
            if (Session["User"] == null)
            {
        ...
        [HttpPost]
        public ActionResult AssembleIndex2(string orderNum, string BoxBarCode, string PQCNormal, string Remark/*, int PageIndex = 0*/)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users");
        ...
        public ActionResult Details(int? id)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "Details" + "/" + id.ToString() });
            }
        ...
        public ActionResult Edit(int? id)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "Edit" + "/" + id.ToString() });
            }
        ...
        public ActionResult Edit([Bind(Include = "Id,OrderNum,BoxBarCode,AssembleBT,AssembleFT,AssembleTime,AssembleFinish,WaterproofTestBT,WaterproofTestFT,WaterproofTestTimeSpan,WaterproofAbnormal,WaterproofMaintaince,WaterproofTestFinish,AssembleAdapterCardBT,AssembleAdapterCardFT,AssembleAdapterTime,AssembleAdapterFinish,ViewCheckBT,ViewCheckFT,ViewCheckTime,ViewCheckAbnormal,ViewCheckFinish,ElectricityCheckBT,ElectricityCheckFT,ElectricityCheckTime,ElectricityCheckAbnormal,ElectricityCheckFinish,PQCCheckBT,AssemblePQCPrincipal,AssembleLineId,PQCCheckFT,PQCCheckTime,PQCCheckAbnormal,PQCCheckFinish")] Assemble assemble)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "Edit" + "/" + assemble.Id.ToString() });
            }
        ...
        public ActionResult Delete(int? id)
        {
            if (Session["User"] == null)
            {
                return RedirectToAction("Login", "Users", new { col = "Assembles", act = "Delete" + "/" + id.ToString() });
            }
