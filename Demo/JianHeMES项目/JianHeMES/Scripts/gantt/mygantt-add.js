...
var my_gantt = function () {
    ...
    var colContent = function (task) {
        let html = ('<i class="fa gantt_button_grid gantt_grid_edit fa-pencil" onclick="clickGridButton(' + task.id + ', \'edit\')"></i>' +
    ...
    gantt.attachEvent("onBeforeGanttRender", function () {
        ...
        if (actual_data && range) {
            ...
            //console.log('actual_max', actual_max,222);
            //console.log('actual_min', actual_min,333);
