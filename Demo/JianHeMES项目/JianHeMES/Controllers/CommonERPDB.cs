    ...
    public class CommonERPDB
    {
        ...
        public static List<cxcr006> ERP_FinanceDetialsQuery()
        {
            ...
            try
            {
                ...
                {
                    cn.Open();
                    //string sql = "SELECT tc_cxc01,tc_cxc02,tc_cxc03,tc_cxc04,tc_cxc05,tc_cxc06,tc_cxc07,tc_cxc08,tc_cxc09,tc_cxc10,tc_cxc11, tc_cxc12,tc_cxc13,tc_cxc14,0 FROM tc_cxc_file ORDER BY tc_cxc01";

                    //加上会计科目  --ima39为料号对应会计科目--0为面积
                    string sql = "SELECT tc_cxc01,tc_cxc02,tc_cxc03,tc_cxc04,tc_cxc05,tc_cxc06,tc_cxc07,tc_cxc08,tc_cxc09,tc_cxc10,tc_cxc11, tc_cxc12,tc_cxc13,tc_cxc14,ima39,0 FROM tc_cxc_file,ima_file where tc_cxc01 = ima01 ORDER BY tc_cxc01";
                    ...
                    foreach (DataRow item in OutDataTable.Rows)
                    {
                        result_list.Add(new cxcr006
                        {
                            ...
                            AccountingSubject = Convert.ToInt32(item[14].ToString()),            //会计科目
                            area = Convert.ToDouble(item.ItemArray[15].ToString()),               //面积
                        });
                    }
                    cn.Dispose();
                    cn.Close();
        ...
        public static List<imk_file> OutsideWarehouseQuery(int year, int month)
        {
            ...
            try
            {
                using (OracleConnection cn = GetOracleConnection())
                {
                    ...
                    //string sql = "select * from imk_file where imk05="+ year +" and imk06=" + month + " and imk02='LCWC1' and imk03='CWC01' and imk09>0";

                    ////加入期末余额计算
                    //string sql = "select distinct imk01, imk02, imk03, imk04, imk05, imk06, imk09, imk09*ccc23 from imk_file, ccc_file where imk02 = 'LCWC1' and imk05 = ccc02 and imk06 = ccc03 and imk09<>0 and imk01 = ccc01(+)  and imk05 = ccc02 and imk06 = ccc03 order by imk01";
        ...
        //在制工单
        public static List<ccg_file> ERP_Work_in_process(DateTime inputdate, DateTime enddate)
        {
            //string sql = "SELECT ccg_file.* , ima12, ima02, ima021, ima911, sfb99 FROM ccg_file , ima_file , sfb_file WHERE ccg04= ima01  AND ccg01 = sfb01 AND ccg02 = "+enddate.Year+" AND ccg03 = "+enddate.Month;
            string sql = "SELECT ccg01,ccg02,ccg03,ccg04,ccg91,ccg92, ima12, ima02, ima021, ima911, sfb99, sfbud01 FROM ccg_file , ima_file , sfb_file WHERE ccg04= ima01  AND ccg01 = sfb01 AND ccg02 = " + enddate.Year + " AND ccg03 = " + enddate.Month;
            string data = string.Empty;
            DataTable OutDataTable = new DataTable();
            OutDataTable.TableName = "data";
            ...
            using (OracleConnection cn = GetOracleConnection())
            {
                ...
                foreach (DataRow dataRow in OutDataTable.Rows)
                {
                    ...
                    //record.durations = result_months < 3?"3个月内":(result_months < 6?"半年内": result_months < 12?"一年以内":"一年以上");                                             //期间
