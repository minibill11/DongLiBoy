...
namespace JianHeMES.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        //根据模块创建的权限清单表
        public DbSet<UserNewPermissions> UserNewPermissions { get; set; }
        ...
        //人员工时明细表
        public DbSet<Personnel_WorkingHours> Personnel_WorkingHours { get; set; }

        //月报/半月报工时明细表
        public DbSet<Personnel_MonthlyReport_WorkingHours> Personnel_MonthlyReport_WorkingHours { get; set; }

        //企业行事历(计算工时需求)
        public DbSet<Personnel_Corporate_Calendar> Personnel_Corporate_Calendar { get; set; }
        ...
        //仓库物料管理：物料入库
        public DbSet<Warehouse_putIn> Warehouse_putIn { get; set; }

        //仓库物料管理：物料条码Warehouse_Material_Bacrcode
        public DbSet<Warehouse_Material_Bacrcode> Warehouse_Material_Bacrcode { get; set; }

        //仓库物料基本信息
        public DbSet<Warehouse_MaterialBasicInfo_Collection> Warehouse_MaterialBasicInfo_Collection { get; set; }

        //仓库物料出库
        public DbSet<Warehouse_Material_Outbound> Warehouse_Material_Outbound { get; set; }

        //仓库收物料基本信息
        public DbSet<Warehouse_Receiving_Information> Warehouse_Receiving_Information { get; set; }


        //仓库物料有效规则
        public DbSet<Warehouse_Material_ValidityPeriod> Warehouse_Material_ValidityPeriod { get; set; }
        ...
        //设备状态记录表
        public DbSet<EquipmentStateTime> EquipmentStateTime { get; set; }
        ...
        public DbSet<Process_Capacity_Manual> Process_Capacity_Manual { get; set; }

        public DbSet<Process_Capacity_Equipment> Process_Capacity_Equipment { get; set; }
        ...
        public DbSet<Process_Capacity_Relevance> Process_Capacity_Relevance { get; set; }
        ...
        public DbSet<ModuleAI> ModuleAI { get; set; }
        public DbSet<AfterWelding> AfterWelding { get; set; }

        public DbSet<ElectricInspection> ElectricInspection { get; set; }
        public DbSet<ModuleSampling> ModuleSampling { get; set; }

        public DbSet<ModuleBurnIn> ModuleBurnIn { get; set; }

        public DbSet<ModuleAppearance> ModuleAppearance { get; set; }

        public DbSet<ModuleInsideTheBox> ModuleInsideTheBox { get; set; }

        public DbSet<ModuleOutsideTheBox> ModuleOutsideTheBox { get; set; }

        public DbSet<ModulePackageRule> ModulePackageRule { get; set; }

        public DbSet<ModuleBoard> ModuleBoard { get; set; }
        #endregion
        ...
        //客诉（投诉代码表）
        public DbSet<Customer_ComplaintsCode> Customer_ComplaintsCode { get; set; }

        //客诉损失明细表AttachmentLoss
        public DbSet<Customer_AttachmentLoss> Customer_AttachmentLoss { get; set; }
        ...
        /// 钣金基本信息表
        /// </summary>
        public DbSet<MetalPlate_BasicInfo> MetalPlate_BasicInfo { get; set; }

        /// <summary>
        /// 钣金生产数据表
        /// </summary>
        public DbSet<MetalPlateProduction> MetalPlateProduction { get; set; }
        #endregion
        ...
        /// 7S区域数据
        /// </summary>
        public DbSet<KPI_7S_DistrictPosition> KPI_7S_DistrictPosition { get; set; }

        /// <summary>
        /// 7S记录表
        /// </summary>
        public DbSet<KPI_7S_Record> KPI_7S_Record { get; set; }

        /// <summary>
        /// 7S扣分参照标准
        /// </summary>
        public DbSet<KPI_7S_ReferenceStandard> KPI_7S_ReferenceStandard { get; set; }

        /// <summary>
        /// 指标录入
        /// </summary>
        public DbSet<KPI_Indicators> KPI_Indicators { get; set; }


        /// <summary>
        /// 品质效率实际记录表
        /// </summary>
        public DbSet<KPI_ActualRecord> KPI_ActualRecord { get; set; }

        /// <summary>
        /// 班组流失率表
        /// </summary>
        public DbSet<KPI_TurnoverRate> KPI_TurnoverRate { get; set; }

        /// <summary>
        /// KPI显示总表
        /// </summary>
        public DbSet<KPI_TotalDisplay> KPI_TotalDisplay { get; set; }

        /// <summary>
        /// 班组评优月度指标汇总表
        /// </summary>
        public DbSet<KPI_MonthlyIndicators> KPI_MonthlyIndicators { get; set; }

        /// <summary>
        /// 各部门负责人审核班组评优月度指标汇总
        /// </summary>
        public DbSet<KPI_ReviewSummary> KPI_ReviewSummary { get; set; }
        ...
        /// 订单总计划表
        /// </summary>
        public DbSet<Plan_FromOrder> Plan_FromOrder { get; set; }

        /// <summary>
        /// 品质效率计划表
        /// </summary>
        public DbSet<Plan_FromKPI> Plan_FromKPI { get; set; }

        /// <summary>
        /// 工序工段编辑表
        /// </summary>
        public DbSet<Plan_SectionParameter> Plan_SectionParameter { get; set; }
        #endregion
        ...
        /// 库存金额记录表
        /// </summary>
        public DbSet<InventoryAmount_Record> InventoryAmount_Record { get; set; }

        /// <summary>
        /// 库存金额审核、核准表
        /// </summary>
        public DbSet<InventoryAmount_Assessed> InventoryAmount_Assessed { get; set; }
        ...
        public DbSet<Version_SectionList> Version_SectionList { get; set; }
        #endregion
