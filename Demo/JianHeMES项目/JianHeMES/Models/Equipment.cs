...
namespace JianHeMES.Models
{
    ...
    public class Equipment_Checkthe_project //设备点检保养项目和操作方法
    {
        ...
        //周保养
        [Display(Name = "周保养项目"), StringLength(200)]
    ...
    public class EquipmentRepairbill //仪器设备报修单
    {
        ...
        //技术部意见
        [Display(Name = "技术部意见"), StringLength(2000)]
        ...
        //联建采购意见
        [Display(Name = "联建采购意见"), StringLength(1500)]
