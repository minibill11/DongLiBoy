...
namespace JianHeMES.Models
{
    ...
    //物料有效期
    public class Warehouse_Material_ValidityPeriod
    {
        [Key]
        public int ID { get; set; }
    ...
    public class InventoryAmount_Assessed
    {
        ...
        [Display(Name = "财务核对结果")]
        public bool? Finance_Proofread { get; set; }

        [Display(Name = "财务核对人"), StringLength(50)]
        public string Finance_Proofreader { get; set; }

        [Display(Name = "财务核对时间")]
        public DateTime? Finance_Proofread_Date { get; set; }

        [Display(Name = "财务核对不通过原因"), StringLength(300)]
        public string Finance_Proofread_Reason { get; set; }


        [Display(Name = "PMC核对结果")]
        public bool? PMC_Proofread { get; set; }

        [Display(Name = "PMC核对人"), StringLength(50)]
        public string Finance_Finance_Proofreader { get; set; }

        [Display(Name = "PMC核对时间")]
        public DateTime? PMC_Proofread_Date { get; set; }

        [Display(Name = "PMC核对不通过原因"), StringLength(300)]
        public string PMC_Proofread_Reason { get; set; }
