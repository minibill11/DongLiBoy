...
$(function set() {
    ...
    vb = parseFloat($("#f11").val());
    vc = parseFloat($("#f12").val());

    vb2 = parseFloat($("#f1").val());
    vc2 = parseFloat($("#f2").val());
    ma = parseFloat($("#f3").val());
    mb = parseFloat($("#f4").val());
    ma2 = parseFloat($("#f5").val());
    mb2 = parseFloat($("#f6").val());
    ma3 = parseFloat($("#f7").val());
    mb3 = parseFloat($("#f8").val());
    ma4 = parseFloat($("#f9").val());
    mb4 = parseFloat($("#f10").val());
